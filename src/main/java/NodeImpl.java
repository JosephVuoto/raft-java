...
public class NodeImpl extends UnicastRemoteObject
     ...
     */
    public int requestVote(int term, int candidateId,
                           int lastLogIndex, int lastLogTerm)
            throws RemoteException {
        return state.requestVote(term, candidateId,
     ...
     */
    public int appendEntries(int term, int leaderId,
                             int prevLogIndex, int prevLogTerm,
                             LogEntry[] entries, int leaderCommit)
            throws RemoteException {
        return state.appendEntries(term, leaderId,
