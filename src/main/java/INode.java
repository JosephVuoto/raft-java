...
public interface INode extends Remote {
	 ...
	 *                         method call.
	 */
	int requestVote(int term, int candidateId, int lastLogIndex,
	 ...
	 * @return if follower accepts the request, return 0. If rejects the
	 *     request,
	 ...
	 *                         method call.
	 */
	int appendEntries(int term, int leaderId, int prevLogIndex,
					  int prevLogTerm, LogEntry[] entries, int leaderCommit)
